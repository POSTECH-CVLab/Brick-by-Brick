...
from rules import rules_artificial
from rules import rules_mnist
...
class Bricks(object):
    ...
    def sample_one(self):
        ...
        cur_rule = np.random.choice(rules_mnist.RULE_CONTACTS_2_4, p=rules_mnist.PROBS_CONTACTS_2_4)
...
#        for trans in translations:
    ...
    def sample_one_artificial(self):
        bricks = self.get_bricks()
        brick_sampled = np.random.choice(bricks)
        ...
        cur_rule = np.random.choice(rules_artificial.RULE_CONTACTS_2_4, p=rules_artificial.PROBS_CONTACTS_2_4)
...
#        for trans in translations:
    ...
    def sample_one_artificial_with_pivot(self):
        bricks = self.get_bricks()
        # brick_sampled = np.random.choice(bricks)

        brick_sampled_idx = np.random.choice(len(bricks))
        brick_sampled = bricks[brick_sampled_idx]
...
#        for trans in translations:
        ...
        if len(new_bricks) == 0:
            ...
            return np.random.choice(new_bricks), brick_sampled_idx

    def sample_one_artificial_with_supervision(self):
        bricks = self.get_bricks()
        # brick_sampled = np.random.choice(bricks)
        ...
        # cur_rule = np.random.choice(rules_artificial.RULE_CONTACTS_2_4, p=rules_artificial.PROBS_CONTACTS_2_4)
        cur_rule = np.random.choice(len(rules_artificial.LIST_RULES_2_4))
...
#        for trans in translations:
    ...
    def sample_one_center_direct(self):
        bricks = self.get_bricks()
        brick_sampled = np.random.choice(bricks)
        ...
        x_trans = np.random.randint(-1,2)
        y_trans = np.random.randint(-1,2)
