...
from baselines.common.lego_policies_mnist_mask_pretrain import PolicyWithValue_Lego_Mnist_NoEdgeGNN
...
class Model(tf.Module):
    ...
    def __init__(self, *, ac_space, policy_network, target_network, hidden_dim, target_hidden_dim, value_network=None, ent_coef, vf_coef, max_grad_norm):
        ...
        self.train_model = PolicyWithValue_Lego_Mnist_NoEdgeGNN(ac_space, policy_network, target_network, hidden_dim, target_hidden_dim, value_network, estimate_q=False)
